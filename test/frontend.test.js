...
test('Vercel build rejects unsafe backend origins and exports public files only', async () => {
  ...
  assert.deepEqual(files.sort(), ['app.js', 'config.js', 'favicon.svg', 'index.html', 'legal.js', 'privacy.html', 'privacy.js', 'robots.txt', 'rules.html', 'sitemap.xml', 'style.css', 'terms.html']);
