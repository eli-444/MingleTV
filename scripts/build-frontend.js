...
export async function buildFrontend(env = process.env) {
  ...
  const files = ['robots.txt', 'sitemap.xml', 'favicon.svg', 'index.html', 'terms.html', 'privacy.html', 'rules.html', 'app.js', 'privacy.js', 'legal.js', 'style.css'];
...
export async function buildSupabaseFrontend(env = process.env) {
  ...
  for (const file of ['robots.txt', 'sitemap.xml', 'favicon.svg', 'index.html', 'terms.html', 'privacy.html', 'rules.html', 'app.js', 'privacy.js', 'legal.js', 'style.css']) {
